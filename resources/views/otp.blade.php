    ...
    <div class="wrapper">
        ...
        <div class="row no-gutters login-row">
            <div class="col align-self-center px-3 text-center">
                <img src="img/information-graphics-otp.png" alt="logo" class="mw-100">
                <form class="form-signin mt-5 ">
                    <div class="form-group">
                        <input type="number" id="otp" class="form-control form-control-lg text-center" placeholder="OTP" required autofocus>
                    </div>

                    <p class="mt-4 d-block text-secondary">
                        We have sent high security one time password to your email address. Please enter above and confirm.
                    </p>
        ...
        <div class="row mx-0 bottom-button-container">
            <div class="col">
                <a href="thankyou.html" class="btn btn-default btn-lg btn-rounded shadow btn-block">Confirm</a>
            </div>
        </div>
        <!-- login buttons -->
    </div>
